...
public abstract class BaseLeadResourceImpl implements LeadResource {
	 ...
	 *
	 * curl -X 'POST' 'http://localhost:8080/o/solar-budget/v1.0/leads' -d $'{"calculatorGas": ___, "personalData": ___}' --header 'Content-Type: application/json' -u 'test@liferay.com:test'
	 */
	@Override
