...
public abstract class BasePropertyResourceImpl implements PropertyResource {
	 ...
	 *
	 * curl -X 'GET' 'http://localhost:8080/o/solar-budget/v1.0/properties/{gateId}'  -u 'test@liferay.com:test'
	 */
	@Override
	@GET
	@Operation(
	...
	@Parameters(value = {@Parameter(in = ParameterIn.PATH, name = "gateId")})
	@Path("/properties/{gateId}")
	@Produces({"application/json", "application/xml"})
	@Tags(value = {@Tag(name = "Property")})
	public Page<Property> getPropertiesGatePage(
			@NotNull @Parameter(hidden = true) @PathParam("gateId") String
				gateId)
		throws Exception {
