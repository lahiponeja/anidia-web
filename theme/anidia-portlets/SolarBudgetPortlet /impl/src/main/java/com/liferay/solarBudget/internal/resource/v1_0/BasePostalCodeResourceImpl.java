...
public abstract class BasePostalCodeResourceImpl implements PostalCodeResource {
	 ...
	 *
	 * curl -X 'GET' 'http://localhost:8080/o/solar-budget/v1.0/municipalities/{postalCode}'  -u 'test@liferay.com:test'
	 */
	@Override
	@GET
	@Operation(
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -X 'GET' 'http://localhost:8080/o/solar-budget/v1.0/postal-codes'  -u 'test@liferay.com:test'
	 */
	@Override
	@GET
	@Operation(
