...
@Generated("")
@OpenAPIDefinition(
	info = @Info(description = "Sample API", license = @License(name = "Apache 2.0", url = "http://www.apache.org/licenses/LICENSE-2.0.html"), title = "My Sample API for VUE", version = "v1.0")
)
@Path("/v1.0")
	...
	private final Set<Class<?>> _resourceClasses = new HashSet<Class<?>>() {
		{
			...
			add(GasBudgetResultResourceImpl.class);
