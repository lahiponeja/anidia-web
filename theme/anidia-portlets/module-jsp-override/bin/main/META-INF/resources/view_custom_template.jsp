...
%>
<p style="color: green">This is a custom template!</p>
...
<%!
private static Log _log = LogFactoryUtil.getLog("com_liferay_asset_publisher_web.view_custom_templaate_jsp");
%>