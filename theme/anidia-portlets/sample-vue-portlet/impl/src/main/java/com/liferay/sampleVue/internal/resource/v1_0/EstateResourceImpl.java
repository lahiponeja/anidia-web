...
import com.liferay.sampleVue.internal.services.SalesforceService;
...
public class EstateResourceImpl extends BaseEstateResourceImpl {
	 ...
	 *
	 * curl -X 'GET' 'http://localhost:8080/o/sample-vue/v1.0/estates/{municipalityId}/{postalCode}/{addressKind}/{addressName}'  -u 'test@liferay.com:test'
	 */
	@Override
	@GET
	@Operation(
