...
public class SolarBudgetRequest {
	...
	@GraphQLName("MonthlyConsumption")
	public static enum MonthlyConsumption {

		SI("Si"), NO("No");

		@JsonCreator
		public static MonthlyConsumption create(String value) {
			for (MonthlyConsumption monthlyConsumption : values()) {
				if (Objects.equals(monthlyConsumption.getValue(), value)) {
		...
		private MonthlyConsumption(String value) {
			_value = value;
		}
	...
	@GraphQLName("PanelsNumber")
	public static enum PanelsNumber {

		SI("Si"), NO("No");

		@JsonCreator
		public static PanelsNumber create(String value) {
			for (PanelsNumber panelsNumber : values()) {
				if (Objects.equals(panelsNumber.getValue(), value)) {
					return panelsNumber;
				}
			}
		...
		private PanelsNumber(String value) {
			_value = value;
		}
	...
	public void setEntryCode(
		UnsafeSupplier<String, Exception> entryCodeUnsafeSupplier) {

		try {
			entryCode = entryCodeUnsafeSupplier.get();
		}
		catch (RuntimeException re) {
			throw re;
		}
	...
	@JsonIgnore
	public String getMonthlyConsumptionAsString() {
		if (monthlyConsumption == null) {
			return null;
		}

		return monthlyConsumption.toString();
	}
	...
	public void setMonthlyConsumption(
		UnsafeSupplier<MonthlyConsumption, Exception>
			monthlyConsumptionUnsafeSupplier) {
	...
	@GraphQLField
	@JsonProperty(access = JsonProperty.Access.READ_WRITE)
	protected MonthlyConsumption monthlyConsumption;
	...
	@Valid
	public PanelsNumber getPanelsNumber() {
		return panelsNumber;
	}

	@JsonIgnore
	public String getPanelsNumberAsString() {
		if (panelsNumber == null) {
			return null;
		}

		return panelsNumber.toString();
	}

	public void setPanelsNumber(PanelsNumber panelsNumber) {
		this.panelsNumber = panelsNumber;
	}

	@JsonIgnore
	public void setPanelsNumber(
		UnsafeSupplier<PanelsNumber, Exception> panelsNumberUnsafeSupplier) {
	...
	@GraphQLField
	@JsonProperty(access = JsonProperty.Access.READ_WRITE)
	protected PanelsNumber panelsNumber;
