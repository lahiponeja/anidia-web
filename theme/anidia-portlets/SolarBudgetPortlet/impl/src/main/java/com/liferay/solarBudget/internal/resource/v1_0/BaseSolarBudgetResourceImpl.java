...
public abstract class BaseSolarBudgetResourceImpl
	 ...
	 *
	 * curl -X 'POST' 'http://localhost:8080/o/solar-budget/v1.0/solar-budgets' -d $'{"houseType": ___, "monthlyConsumption": ___}' --header 'Content-Type: application/json' -u 'test@liferay.com:test'
	 */
	@Override
