...
public abstract class BaseSolarBudgetResourceImpl
	 ...
	 *
	 * curl -X 'POST' 'http://localhost:8080/o/solar-budget/v1.0/solar-budgets' -d $'{"additionalPanels": ___, "annualConsumption": ___, "carCharger": ___, "electricalAppliances": ___, "entryCode": ___, "hasAdditionalPanels": ___, "houseType": ___, "installationType": ___, "inverterOversized": ___, "inverterType": ___, "monthlyConsumption": ___, "needBattery": ___, "numberAdditionalPanels": ___, "panelsCanTell": ___, "panelsNumber": ___, "panelsSelected": ___, "pergola": ___, "pipelineMeters": ___, "pipelineUnderground": ___, "roofType": ___}' --header 'Content-Type: application/json' -u 'test@liferay.com:test'
	 */
	@Override
