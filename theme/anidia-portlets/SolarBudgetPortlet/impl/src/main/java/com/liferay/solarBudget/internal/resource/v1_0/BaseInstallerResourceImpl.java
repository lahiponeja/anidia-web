...
@Generated("")
@Path("/v1.0")
public abstract class BaseInstallerResourceImpl implements InstallerResource {

	/**
	 * Invoke this method with the command line:
	 *
	 * curl -X 'GET' 'http://localhost:8080/o/solar-budget/v1.0/availability'  -u 'test@liferay.com:test'
	 */
	@Override
	@GET
	@Operation(description = "Get solar installer availability")
	@Parameters(
		value = {
	...
	protected void preparePatch(
		Installer installer, Installer existingInstaller) {
	}
