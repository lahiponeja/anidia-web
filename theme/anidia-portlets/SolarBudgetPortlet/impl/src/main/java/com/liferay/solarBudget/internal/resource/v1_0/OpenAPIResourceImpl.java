...
@Generated("")
@OpenAPIDefinition(
	info = @Info(description = "Solar Budget API", license = @License(name = "Apache 2.0", url = "http://www.apache.org/licenses/LICENSE-2.0.html"), title = "Anidia's Solar Budget AI", version = "v1.0")
)
@Path("/v1.0")
public class OpenAPIResourceImpl {
	...
	private final Set<Class<?>> _resourceClasses = new HashSet<Class<?>>() {
		{
			add(InstallerResourceImpl.class);
